...
* **statement of proof**: [digital identity card](./slide-cppm.png)
...
* **statement of proof**: [dhcp assignment](./slide-dhcp.png)
...
* **statement of proof**: [pbf routing logic](./slide-pbf.png)
...
* **statement of proof**: [packet capture analysis](./slide-pcap.png)
