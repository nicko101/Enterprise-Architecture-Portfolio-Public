# validation criteria | user id

## overview
technical documentation and evidence for the validation criteria of the user id service within the palo alto security suite.
